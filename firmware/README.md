...
| `OB_FLASH_PAGE_ERASE` | `0` | ch59x-only: `1` uses 256 B page erase (`0x81`) instead of 4 KiB sector erase. **Opt-in — hangs a CH592A; only enable on a die verified to support it (e.g. CH592F).** See `docs/AB-UPDATE.md` and `ports/CH32FUN.md` |
